...
import net.jonathan.jonathansbatsuits.entity.client.armor.renderers.TasRenderer;
...
public class TasItem extends ArmorItem implements GeoItem {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    private final Supplier<Object> renderProvider = GeoItem.makeRenderer(this);
    public TasItem(Type type, Settings settings) {
        super(ModArmorMaterials.TAS, type, settings);
    }
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        controllers.add(new AnimationController<>(this, 20, state -> {
            ...
            boolean isFullSet = wornArmor.containsAll(ObjectArrayList.of(
                    ModItems.TAS_BOOTS,
                    ModItems.TAS_LEGGINGS,
                    ModItems.TAS_CHESTPLATE,
                    ModItems.TAS_COWL));
    ...
    public static Boolean isWearingAll(LivingEntity entity) {
        return entity.getEquippedStack(EquipmentSlot.FEET).isOf(ModItems.TAS_BOOTS) &&
                entity.getEquippedStack(EquipmentSlot.LEGS).isOf(ModItems.TAS_LEGGINGS) &&
                entity.getEquippedStack(EquipmentSlot.CHEST).isOf(ModItems.TAS_CHESTPLATE) &&
                entity.getEquippedStack(EquipmentSlot.HEAD).isOf(ModItems.TAS_COWL);
    }
