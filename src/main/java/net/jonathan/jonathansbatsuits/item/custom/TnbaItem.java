...
import net.jonathan.jonathansbatsuits.entity.client.armor.renderers.TnbaRenderer;
...
public class TnbaItem extends ArmorItem implements GeoItem {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    private final Supplier<Object> renderProvider = GeoItem.makeRenderer(this);
    public TnbaItem(Type type, Settings settings) {
        super(ModArmorMaterials.TNBA, type, settings);
    }
        ...
        consumer.accept(new RenderProvider() {
            ...
            public BipedEntityModel<LivingEntity> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack, EquipmentSlot equipmentSlot,
                ...
                if(this.renderer == null)
                    this.renderer = new TnbaRenderer();
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        controllers.add(new AnimationController<>(this, 20, state -> {
            ...
            boolean isFullSet = wornArmor.containsAll(ObjectArrayList.of(
                    ModItems.TNBA_BOOTS,
                    ModItems.TNBA_LEGGINGS,
                    ModItems.TNBA_CHESTPLATE,
                    ModItems.TNBA_COWL));
    ...
    public static Boolean isWearingAll(LivingEntity entity) {
        return entity.getEquippedStack(EquipmentSlot.FEET).isOf(ModItems.TNBA_BOOTS) &&
                entity.getEquippedStack(EquipmentSlot.LEGS).isOf(ModItems.TNBA_LEGGINGS) &&
                entity.getEquippedStack(EquipmentSlot.CHEST).isOf(ModItems.TNBA_CHESTPLATE) &&
                entity.getEquippedStack(EquipmentSlot.HEAD).isOf(ModItems.TNBA_COWL);
    }
